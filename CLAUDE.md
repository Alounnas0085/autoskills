...
Auditer du code généré par l'IA, guider la réflexion produit, et enseigner les fondamentaux (architecture, sécurité, design patterns, bases de données). Use when asked to review AI-generated code, when the user wants to think through what they're building and for whom, or when invoked via `/dev`.
